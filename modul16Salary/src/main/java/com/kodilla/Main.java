...
class Application {                                // [7]
    ...
    public static void main(String args[]) {
        ...
        FixedSalaryEmployee employeeObjekt = new FixedSalaryEmployee(2.0);

        SalaryPayoutProcessor processorObjekt = new SalaryPayoutProcessor(employeeObjekt);
        processorObjekt.processPayout();
